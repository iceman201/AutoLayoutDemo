...
extension UILabel {
    convenience init(fontAwesome size: CGFloat, type:awesomeType) {
        self.init()
        self.font = type == .Regular ? UIFont(name: "FontAwesome5FreeRegular", size: size) : UIFont(name: "FontAwesome5FreeSolid", size: size)
...
extension UIButton {
    convenience init(fontAwesome size: CGFloat, type:awesomeType) {
        self.init()
        self.titleLabel?.font = type == .Regular ? UIFont(name: "FontAwesome5FreeRegular", size: size) : UIFont(name: "FontAwesome5FreeSolid", size: size)
    }
}
